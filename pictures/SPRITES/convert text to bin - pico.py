...
#             print(f"Erro: O arquivo {filename}.txt não foi encontrado.")
#         else:
#             print(f"Erro inesperado ao acessar {filename}.txt: {e}")
...
filenames = ["button_full_ok_bottom", "button_full_ok_top"]
